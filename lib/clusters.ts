...
export const CLUSTERS: Cluster[] = [
  ...
  },
  {
    ...
    intro:
      'After 50, recovery is the limiting factor, not effort or willpower. The lifters who keep progressing are the ones who manage recovery as deliberately as they manage their working sets. These guides cover frequency, deloads, sleep, and the signals worth tracking.',
  },
  {
    slug: 'programs',
    name: 'Programs',
    ...
    intro:
      'Most popular programs were written for 25-year-olds and quietly assume 25-year-old recovery. These guides cover how masters programming differs in progression speed, volume, and deload timing, and how to run a 12-week block that ends with you stronger, not injured.',
  },
  {
    slug: 'longevity',
    name: 'Longevity',
